...
; The product loop must unroll completely: with the sums vector indexed by the
; loop counter every backend spills it to scratch, and AMD scratch frames grow
; past the compiler limit.
!0 = distinct !{!0, !1}
