...
%k = phi i32 [ 0, %entry ], [ %k.next, %register.done ] %k.more = icmp ult i32 %k, %k.count br i1 %k.more, label %k.load, label %exit k.load:
%a.row = mul i32 %k, %tile.m %a.index = add i32 %a.row, %output.m.base %a.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile, i32 0, i32 %a.index %a.fragment = load <RECIPE_REGISTER_M x double>, ptr addrspace(3) %a.ptr, align 8 %b.base = mul i32 %tile.m, %tile.k %b.row = mul i32 %k, %tile.n %b.local = add i32 %b.row, %output.n.base %b.index = add i32 %b.base, %b.local %b.ptr = getelementptr [0 x double], ptr addrspace(3) @contraction_tile, i32 0, i32 %b.index %b.fragment = load <RECIPE_REGISTER_N x double>, ptr addrspace(3) %b.ptr, align 8 br label %register.loop register.loop:
%register = phi i32 [ 0, %k.load ], [ %register.next, %register.next.step ] %register.more = icmp ult i32 %register, RECIPE_REGISTER_COUNT br i1 %register.more, label %register.step, label %register.done
...
%output.m.valid = icmp ult i32 %output.m.raw, %m.count %output.n.valid = icmp ult i32 %output.n.raw, %n.count %output.valid = and i1 %output.m.valid, %output.n.valid %active = and i1 %lane.active, %output.valid
%a = extractelement <RECIPE_REGISTER_M x double> %a.fragment, i32 %register.local.m %b = extractelement <RECIPE_REGISTER_N x double> %b.fragment, i32 %register.local.n
...
%gradient.jobs = mul i32 %gradient.m.tiles, %gradient.n.tiles %gradient.r.tiles.base = udiv i32 %gradient.r.total, %gradient.k.tile %gradient.r.tiles.tail = urem i32 %gradient.r.total, %gradient.k.tile %gradient.r.tiles.has.tail = icmp ne i32 %gradient.r.tiles.tail, 0 %gradient.r.tiles.next = add i32 %gradient.r.tiles.base, 1 %gradient.r.tiles = select i1 %gradient.r.tiles.has.tail, i32 %gradient.r.tiles.next, i32 %gradient.r.tiles.base %gradient.splits.raw = udiv i32 %groups, %gradient.jobs %gradient.splits.short = icmp ult i32 %gradient.splits.raw, %gradient.r.tiles %gradient.splits.limit = select i1 %gradient.splits.short, i32 %gradient.splits.raw, i32 %gradient.r.tiles %gradient.splits.present = icmp ne i32 %gradient.splits.limit, 0 %gradient.splits = select i1 %gradient.splits.present, i32 %gradient.splits.limit, i32 1 %gradient.tasks = mul i32 %gradient.jobs, %gradient.splits br label %gradient.job.loop gradient.job.loop:
%gradient.job = phi i32 [ %group, %entry ], [ %gradient.job.next, %gradient.job.done ] %gradient.job.more = icmp ult i32 %gradient.job, %gradient.tasks
br i1 %gradient.job.more, label %gradient.job.step, label %previous.test gradient.job.step:
%gradient.job.index = udiv i32 %gradient.job, %gradient.splits %gradient.split = urem i32 %gradient.job, %gradient.splits %gradient.m.group.short = icmp ult i32 %gradient.m.tiles, RECIPE_CONTRACTION_SWIZZLE_M %gradient.m.group.limit = select i1 %gradient.m.group.short, i32 %gradient.m.tiles, i32 RECIPE_CONTRACTION_SWIZZLE_M %gradient.group.width = mul i32 %gradient.m.group.limit, %gradient.n.tiles %gradient.group.index = udiv i32 %gradient.job.index, %gradient.group.width %gradient.m.group.base = mul i32 %gradient.group.index, %gradient.m.group.limit %gradient.m.group.remaining = sub i32 %gradient.m.tiles, %gradient.m.group.base %gradient.m.group.tail = icmp ult i32 %gradient.m.group.remaining, %gradient.m.group.limit %gradient.m.group.count = select i1 %gradient.m.group.tail, i32 %gradient.m.group.remaining, i32 %gradient.m.group.limit %gradient.group.local = urem i32 %gradient.job.index, %gradient.group.width %gradient.m.group.local = urem i32 %gradient.group.local, %gradient.m.group.count %gradient.m.index = add i32 %gradient.m.group.base, %gradient.m.group.local %gradient.n.index = udiv i32 %gradient.group.local, %gradient.m.group.count %gradient.m.base = mul i32 %gradient.m.index, %gradient.m.tile %gradient.n.base = mul i32 %gradient.n.index, %gradient.n.tile
...
%gradient.r.tile = phi i32 [ %gradient.split, %gradient.bias.init.loop ], [ %gradient.r.tile.next, %gradient.tile.done ] %gradient.r.base = mul i32 %gradient.r.tile, %gradient.k.tile
...
%gradient.r.tile.next = add i32 %gradient.r.tile, %gradient.splits %gradient.r.more = icmp ult i32 %gradient.r.tile.next, %gradient.r.tiles br i1 %gradient.r.more, label %gradient.tile.done, label %gradient.store.loop gradient.tile.done: br label %gradient.tile.loop gradient.store.loop:
...
%gradient.store.ptr = getelementptr inbounds double, ptr addrspace(1) %gradient, i32 %gradient.store.index %gradient.store.sum.ptr = getelementptr [RECIPE_REGISTER_COUNT x double], ptr addrspace(5) %sums, i32 0, i32 %gradient.store.register %gradient.store.sum = load double, ptr addrspace(5) %gradient.store.sum.ptr, align 8 call double @recipe.atomic.add(ptr addrspace(1) %gradient.store.ptr, double %gradient.store.sum)
...
%gradient.store.bias.value.ptr = getelementptr [RECIPE_REGISTER_N x double], ptr addrspace(5) %biases, i32 0, i32 %gradient.store.register.n %gradient.store.bias.value = load double, ptr addrspace(5) %gradient.store.bias.value.ptr, align 8 call double @recipe.atomic.add(ptr addrspace(1) %gradient.store.bias.ptr, double %gradient.store.bias.value) br label %gradient.store.next
