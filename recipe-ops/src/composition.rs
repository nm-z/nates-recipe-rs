...
impl CompositionStep {
	#[must_use]
	pub const fn primitive(family: PrimitiveFamily, role: &'static str) -> Self {
		Self::Primitive { family, role }
	}
...
impl CompositionRecipe {
	...
	#[must_use]
	pub const fn steps(self) -> &'static [CompositionStep] {
		self.steps
	}

	#[must_use]
	pub const fn payload(self) -> CompositionPayload {
		self.payload
	}
	...
	pub(crate) fn for_entry(symbol: &str, source: &str) -> Option<Self> {
		composition_for_entry(symbol, source)
	}
...
fn composition_for_entry(symbol: &str, source: &str) -> Option<CompositionRecipe> {
	let value = match symbol {
		"convert" | "dequant_f32" | "gpu_convert" => recipe(
		...
		"gpu_argmax_accuracy_into" => recipe(
		...
		"gpu_add_col_scaled_inplace" => recipe(
		...
		"gpu_avg_pool_1d" | "gpu_avg_pool_2d" | "gpu_avg_pool_2d_f32" => recipe(
			"average_pool",
		...
		"gpu_avg_pool_2d_backward" | "gpu_avg_pool_2d_backward_f32" => recipe(
		...
		"gpu_batchnorm_inference" => recipe(
		...
		"gpu_bernoulli_into" | "gpu_bernoulli_u8" => recipe(
			"bernoulli_i32",
		...
		"gpu_bernoulli_nb_logprob" => recipe(
		...
		"gpu_bitonic_step" | "gpu_bitonic_step_dd" | "gpu_bitonic_step_idx" => recipe(
		...
		"gpu_categorical_logprob" => recipe(
		...
		"gpu_causal_softmax_rows" => recipe(
			"causal_row_softmax",
		...
		"gpu_cholesky_solve" | "gpu_potrs" => recipe(
			"cholesky_solve",
		...
		"gpu_col2im_1d" | "gpu_col2im_2d" | "gpu_col2im_2d_ext" => recipe(
			"column_to_image",
		...
		"gpu_concat_into" | "gpu_vconcat" => recipe(
		...
		"gpu_cosine_embedding_loss" => recipe(
		...
		"gpu_count_distinct" | "gpu_run_length" => recipe(
			"stable_run_encoding",
		...
		"gpu_csr_spmv" | "gpu_csr_spmm" => recipe(
		...
		"gpu_fft_c2c_1d" | "gpu_rfft_1d" => recipe(
			"stockham_fft_1d",
		...
		"gpu_fixed_radius_neighbors" => recipe(
		...
		"gpu_flash_attention_into" | "gpu_flash_gqa" | "gpu_flash_mla" => recipe(
		...
		"gpu_flash_attention_train_into" => recipe(
		...
		"gpu_flash_attention_backward_into" => recipe(
		...
		"gpu_gaussian_ll" | "gpu_gaussian_logprob" => recipe(
		...
		"gpu_grad_hess_into" | "gpu_logloss_grad_f32" | "gpu_logloss_grad_mc" => recipe(
		...
		"gpu_gru_cell" | "gpu_gru_cell_f32" => recipe(
			"gru_cell",
		...
		"gpu_im2col_1d" | "gpu_im2col_2d" | "gpu_im2col_2d_ext" => recipe(
			"image_to_column",
		...
		"gpu_kernel_matrix" | "gpu_smo_kernel_row" => recipe(
			"svm_kernel_matrix",
		...
		"gpu_layernorm_f32" | "gpu_layernorm_into" | "gpu_layernorm_opt_into" => recipe(
			"layer_normalization",
		...
		"gpu_layernorm_backward_f32" | "gpu_layernorm_backward_full_into" => recipe(
		...
		"gpu_leaf_finalize" | "gpu_lgbm_leaf_reduce" => recipe(
		...
		"gpu_leaf_reduce" | "gpu_scatter_add_by_leaf" | "gpu_scatter_add_by_leaf_col" => recipe(
		...
		"gpu_lgbm_best_split" | "gpu_oblivious_split_eval" | "gpu_split_eval" | "gpu_tb_split_eval" => recipe(
		...
		"gpu_lgbm_histogram" | "gpu_oblivious_histogram" | "gpu_tb_histogram" => recipe(
		...
		"gpu_linear_into" | "gpu_linear_f32" | "gpu_matvec_bias_into" => recipe(
			"linear_projection",
		...
		"gpu_lstm_cell" | "gpu_lstm_cell_f32" => recipe(
			"lstm_cell",
		...
		"gpu_max_pool_1d" | "gpu_max_pool_2d" | "gpu_max_pool_2d_f32" => recipe(
			"maximum_pool",
		...
		"gpu_moe_weighted_accumulate" => recipe(
		...
		"gpu_moe_weighted_accumulate_backward" | "gpu_moe_backward" => recipe(
		...
		"gpu_multinomial_nb_logprob" => recipe(
		...
		"gpu_nb_feature_log_prob" => recipe(
		...
		"gpu_ordered_target_stats" => recipe(
		...
		"gpu_partial_argsort" | "gpu_topk_per_row" => recipe(
		...
		"gpu_positional_encoding" => recipe(
		...
		"gpu_random_threshold_split" => recipe(
		...
		"gpu_rmsnorm" | "gpu_rmsnorm_f64" | "gpu_rmsnorm_f64_nogamma" => recipe(
		...
		| "gpu_rope_qk"
		| "gpu_rope_qk_heads_inplace" => recipe(
		...
		"gpu_scaled_dot_product_attn" => recipe(
		...
		"gpu_scan_linear_recurrence" => recipe(
		...
		"gpu_segment_max" | "gpu_segment_sum" => recipe(
			"segmented_reduction",
		...
		"gpu_slice_cols" | "gpu_slice_rows" | "gpu_slice_lead_into" => recipe(
		...
		"gpu_smo_update_gradient_rows" => recipe(
			"smo_gradient_update",
		...
		"gpu_softmax_rows_into" | "gpu_softmax_inplace" => recipe(
			"row_softmax",
		...
		"gpu_softmax_backward_into" => recipe(
			"softmax_backward",
		...
		"gpu_softmax_ce_class_grad_f32" | "gpu_softmax_ce_grad_into" => recipe(
		...
		"gpu_ssm_conv_causal" | "gpu_ssm_conv_causal_silu" => recipe(
		...
		"gpu_ssm_scan_mamba1" | "gpu_ssm_scan_mamba2" => recipe(
		...
		"gpu_tb_apply_tree" | "gpu_tree_ensemble_predict" => recipe(
		...
		"gpu_tb_leaf_sum" | "gpu_tb_leaf_val" => recipe(
		...
		"gpu_tb_repartition" | "gpu_tb_scatter" => recipe(
		...
		"gpu_upsample_nearest_2d" => recipe(
		...
		"gpu_vae_backward_latent" => recipe(
			"vae_latent_backward",
