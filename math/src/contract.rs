...
impl MathFunction {
	...
	pub const fn arity(self) -> usize {
		match self {
			...
			Self::Reciprocal | Self::ReciprocalSquareRoot | Self::Sin | Self::Cos | Self::Tan | Self::Exp | Self::ExpWithGradualUnderflow | Self::ExpMinusOne | Self::Log | Self::LogOnePlus | Self::Floor | Self::Ceil | Self::RoundNearestEven | Self::Trunc | Self::Sign | Self::Sigmoid | Self::Tanh | Self::Softplus | Self::Erf => 1,
		}
	}
	...
	const fn signed_zero_behavior(self) -> &'static str {
		match self {
			Self::Reciprocal | Self::ReciprocalSquareRoot | Self::Log => "positive and negative zero are rejected",
			Self::Sin | Self::Tan | Self::ExpMinusOne | Self::LogOnePlus | Self::Floor | Self::Ceil | Self::RoundNearestEven | Self::Trunc | Self::Sign | Self::Tanh | Self::Erf => "an input signed zero is preserved exactly",
			Self::Cos | Self::Exp | Self::ExpWithGradualUnderflow | Self::Pow => "either signed zero maps to positive one when it is in-domain",
	...
	const fn error_bound(self) -> ErrorBound {
		match self {
			Self::Reciprocal | Self::ReciprocalSquareRoot | Self::Floor | Self::Ceil | Self::RoundNearestEven | Self::Trunc | Self::Fmod | Self::Sign => {
				ErrorBound {
