...
pub enum NativeBackendKind { Cuda, Hsa, }

/// Bounded evidence derived from the real resources retained immediately
/// before native teardown.
#[derive(Clone, Debug, PartialEq, Eq)]
pub struct NativeDeviceExecutionEvidence { pub device: DeviceId, pub backend: NativeBackendKind, pub image_loads: usize,
	pub entry_lookups: usize, pub queues: usize, pub completion_objects: usize, pub persistent_allocations: usize, }
...
pub struct NativeExecutionEvidence { devices: Vec<NativeDeviceExecutionEvidence>, loop_realization_calls: u64,
	teardown_completed: bool, live_resources_after_teardown: usize, }

impl NativeExecutionEvidence { pub(crate) fn completed(devices: Vec<NativeDeviceExecutionEvidence>) -> Self { Self {
			devices, loop_realization_calls: 0, teardown_completed: true, live_resources_after_teardown: 0, } }
