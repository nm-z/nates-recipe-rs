...
impl ParameterBlock {
	...
	pub(crate) unsafe fn enqueue<'context>(&mut self, stream: &Stream<'context>, function: &Function<'_, 'context>, config: LaunchConfig, argument_count: usize) -> recipe_cuda::Result<()> {
