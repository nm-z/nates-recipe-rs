...
use recipe_ingest::PrepareError; use recipe_language::{LanguageError, OgdlCodecError}; use recipe_ops::OperationError;
use recipe_program::ProgramError;

#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[non_exhaustive]
pub enum TrainingCompileErrorKind { EmptyDataset, InconsistentRows, InvalidFeatureMatrix, InvalidTargetMatrix,
	InvalidNetwork, InvalidOptimizer, UnsupportedExtent, ArithmeticOverflow, IdentityExhausted, Ingest, Language,
	Operation, Program, Ogdl, }

#[derive(Clone, Debug, PartialEq, Eq)]
pub struct TrainingCompileError { pub kind: TrainingCompileErrorKind, pub detail: String, }

impl TrainingCompileError {
	/// Constructs a new value.
	pub(crate) fn new(kind: TrainingCompileErrorKind, detail: impl Into<String>) -> Self { Self { kind,
			detail: detail.into(), } } }
