...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	.text
	.protected	normx_rmsnorm_kernel    ; -- Begin function normx_rmsnorm_kernel
	.globl	normx_rmsnorm_kernel
	.p2align	8
	.type	normx_rmsnorm_kernel,@function
normx_rmsnorm_kernel:                   ; @normx_rmsnorm_kernel
; %bb.0:
...
.LBB3_17:
	...
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel normx_rmsnorm_kernel
		.amdhsa_group_segment_fixed_size 256
		.amdhsa_private_segment_fixed_size 0
	...
	.text
.Lfunc_end3:
	.size	normx_rmsnorm_kernel, .Lfunc_end3-normx_rmsnorm_kernel
                                        ; -- End function
	.set normx_rmsnorm_kernel.num_vgpr, 13
	.set normx_rmsnorm_kernel.num_agpr, 0
	.set normx_rmsnorm_kernel.numbered_sgpr, 17
	.set normx_rmsnorm_kernel.num_named_barrier, 0
	.set normx_rmsnorm_kernel.private_seg_size, 0
	.set normx_rmsnorm_kernel.uses_vcc, 1
	.set normx_rmsnorm_kernel.uses_flat_scratch, 0
	.set normx_rmsnorm_kernel.has_dyn_sized_stack, 0
	.set normx_rmsnorm_kernel.has_recursion, 0
	.set normx_rmsnorm_kernel.has_indirect_call, 0
	.section	.AMDGPU.csdata,"",@progbits
; Kernel info:
; codeLenInByte = 1468
; TotalNumSgprs: 19
...
amdhsa.kernels:
  ...
  - .args:
    ...
    .language_version:
      ...
      - 0
    .max_flat_workgroup_size: 1024
    .name:           normx_rmsnorm_kernel
    .private_segment_fixed_size: 0
    .sgpr_count:     19
    .sgpr_spill_count: 0
    .symbol:         normx_rmsnorm_kernel.kd
    .uniform_work_group_size: 1
    .uses_dynamic_stack: false
    .vgpr_count:     13
    .vgpr_spill_count: 0
