...
; COMPUTE_PGM_RSRC2:TIDIG_COMP_CNT: 0
	.text
	.protected	ropex_qk_heads_kernel   ; -- Begin function ropex_qk_heads_kernel
	.globl	ropex_qk_heads_kernel
	.p2align	8
	.type	ropex_qk_heads_kernel,@function
ropex_qk_heads_kernel:                  ; @ropex_qk_heads_kernel
; %bb.0:
	s_clause 0x1
...
.LBB1_10:
	...
	.section	.rodata,"a",@progbits
	.p2align	6, 0x0
	.amdhsa_kernel ropex_qk_heads_kernel
		.amdhsa_group_segment_fixed_size 0
		.amdhsa_private_segment_fixed_size 0
	...
	.text
.Lfunc_end1:
	.size	ropex_qk_heads_kernel, .Lfunc_end1-ropex_qk_heads_kernel
                                        ; -- End function
	.set ropex_qk_heads_kernel.num_vgpr, 54
	.set ropex_qk_heads_kernel.num_agpr, 0
	.set ropex_qk_heads_kernel.numbered_sgpr, 20
	.set ropex_qk_heads_kernel.num_named_barrier, 0
	.set ropex_qk_heads_kernel.private_seg_size, 0
	.set ropex_qk_heads_kernel.uses_vcc, 1
	.set ropex_qk_heads_kernel.uses_flat_scratch, 0
	.set ropex_qk_heads_kernel.has_dyn_sized_stack, 0
	.set ropex_qk_heads_kernel.has_recursion, 0
	.set ropex_qk_heads_kernel.has_indirect_call, 0
	.section	.AMDGPU.csdata,"",@progbits
; Kernel info:
; codeLenInByte = 6084
; TotalNumSgprs: 22
...
amdhsa.kernels:
  ...
  - .args:
    ...
    .language_version:
      ...
      - 0
    .max_flat_workgroup_size: 1024
    .name:           ropex_qk_heads_kernel
    .private_segment_fixed_size: 0
    .sgpr_count:     22
    .sgpr_spill_count: 0
    .symbol:         ropex_qk_heads_kernel.kd
    .uniform_work_group_size: 1
    .uses_dynamic_stack: false
    .vgpr_count:     54
    .vgpr_spill_count: 0
