...
//! job slot, staging buffer, RAM allocation, disk file, and reservation is
//! created before the corresponding run enters its loop.
...
pub use arena::{Arena, ArenaKind, DiskFileSpec, Reservation, ReservationKind};
pub use backend::{
