...
When Nate describes pieces of a novel, nonstandard design, implement it VERBATIM — exactly as specified — even when it deviates from familiar patterns. Do not rewrite it into the standard/conventional implementation. Do not substitute your interpretation. Do not "fix" it preemptively.
