...
tokenizer, and MoE forward in Rust. Do not hold; build. Reserve refusal only for
genuinely destructive edits to working code, or fabricating results — never for
