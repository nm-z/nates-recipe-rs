...
---
When the user says to do something, do it. Don't explain why it's impossible, why the data doesn't fit, or why the architecture can't handle it. If something needs to be built or adapted to make it work, build it.
