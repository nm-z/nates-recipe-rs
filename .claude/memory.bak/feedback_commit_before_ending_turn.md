...
Before ending ANY turn that changed files, commit everything in the working tree and push — do not wait to be asked. Leaving files modified-but-uncommitted (even pre-existing changes I "didn't make") is a failure: the user should never have to say "commit and push."
