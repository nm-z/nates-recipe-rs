...
pub fn validate_artifact_compatibility(cubin: &[u8], expected: &ArtifactIdentity, observed: &ArtifactIdentity, deployment: &DeploymentIdentity) -> core::result::Result<(), ArtifactCompatibilityError> {
