...
unsafe extern "C" {
      ...
      fn launch_elementwise_binaryx_copysign(a: *const c_void, b: *const c_void, out: *mut c_void, n: i32, s: *mut c_void);
      fn launch_elementwise_binaryx_nextafter(a: *const c_void, b: *const c_void, out: *mut c_void, n: i32, s: *mut c_void);
      fn launch_elementwise_binaryx_logaddexp(a: *const c_void, b: *const c_void, out: *mut c_void, n: i32, s: *mut c_void);
      fn launch_elementwise_binaryx_logaddexp2(a: *const c_void, b: *const c_void, out: *mut c_void, n: i32, s: *mut c_void);
      fn launch_elementwise_binaryx_remainder(a: *const c_void, b: *const c_void, out: *mut c_void, n: i32, s: *mut c_void);
      fn launch_elementwise_binaryx_floor_divide(a: *const c_void, b: *const c_void, out: *mut c_void, n: i32, s: *mut c_void);
      fn launch_elementwise_binaryx_heaviside(a: *const c_void, b: *const c_void, out: *mut c_void, n: i32, s: *mut c_void);
      ...
      fn launch_elementwise_binaryx_xlog1py(a: *const c_void, b: *const c_void, out: *mut c_void, n: i32, s: *mut c_void);
      fn launch_elementwise_binaryx_squared_difference(a: *const c_void, b: *const c_void, out: *mut c_void, n: i32, s: *mut c_void);
...
fn registry() -> HashMap<&'static str, BinOp> {
      use gpu_core::kernels::{gpu_add, gpu_sub, gpu_mul, gpu_div, gpu_gt, gpu_lt, gpu_eq};
      use gpu_core::math_ops::{gpu_max, gpu_min, gpu_atan2, gpu_fmod};
      let mut m: HashMap<&'static str, BinOp> = HashMap::new();
      // existing wrappers
      macro_rules! w {
            ($k:literal, $g:expr, $o:expr, $alo:expr,$ahi:expr,$blo:expr,$bhi:expr) => {
                  m.insert($k, BinOp{op:Op::Wrap($g), oracle:$o, alo:$alo,ahi:$ahi,blo:$blo,bhi:$bhi, tol:1e-7});
            };
      }
      // new raw launchers
      macro_rules! r {
            ($k:literal, $g:expr, $o:expr, $alo:expr,$ahi:expr,$blo:expr,$bhi:expr) => {
                  m.insert($k, BinOp{op:Op::Raw($g), oracle:$o, alo:$alo,ahi:$ahi,blo:$blo,bhi:$bhi, tol:1e-7});
            };
      }
      ...
      w!("gt", gpu_gt, |a, b| if a > b { 1.0 } else { 0.0 }, -3.0, 3.0, -2.3, 3.7);
      w!("lt", gpu_lt, |a, b| if a < b { 1.0 } else { 0.0 }, -3.0, 3.0, -2.3, 3.7);
      w!("eq", gpu_eq, |a, b| if a == b { 1.0 } else { 0.0 }, -3.0, 3.0, -2.3, 3.7);

      // --- new tail ops (raw launchers) ---
      r!("pow", launch_elementwise_binaryx_pow, |a: f64, b| a.powf(b), 0.2, 4.0, -2.0, 3.0);
      r!("hypot", launch_elementwise_binaryx_hypot, |a: f64, b| a.hypot(b), -3.0, 3.0, -2.3, 3.7);
      r!("fmax", launch_elementwise_binaryx_fmax, |a: f64, b| a.max(b), -3.0, 3.0, -2.3, 3.7);
      r!("fmin", launch_elementwise_binaryx_fmin, |a: f64, b| a.min(b), -3.0, 3.0, -2.3, 3.7);
      r!("copysign", launch_elementwise_binaryx_copysign, |a: f64, b| a.copysign(b), -3.0, 3.0, -2.3, 3.7);
      r!("nextafter", launch_elementwise_binaryx_nextafter, |a, b| libm::nextafter(a, b), -3.0, 3.0, -2.3, 3.7);
      r!("logaddexp", launch_elementwise_binaryx_logaddexp, |a: f64, b: f64| (a.exp() + b.exp()).ln(), -3.0, 3.0, -2.3, 3.7);
      r!("logaddexp2", launch_elementwise_binaryx_logaddexp2, |a: f64, b: f64| (a.exp2() + b.exp2()).log2(), -3.0, 3.0, -2.3, 3.7);
      r!("remainder", launch_elementwise_binaryx_remainder, |a: f64, b: f64| a - (a / b).floor() * b, -3.0, 3.0, 0.7, 3.7);
      r!("floor_divide", launch_elementwise_binaryx_floor_divide, |a: f64, b: f64| (a / b).floor(), -3.0, 3.0, 0.7, 3.7);
      r!("heaviside", launch_elementwise_binaryx_heaviside, |a: f64, b| if a < 0.0 { 0.0 } else if a > 0.0 { 1.0 } else { b }, -3.0, 3.0, -2.3, 3.7);
      r!("ldexp", launch_elementwise_binaryx_ldexp, |a: f64, b: f64| a * b.exp2(), -3.0, 3.0, -2.0, 3.0);
      r!("xlogy", launch_elementwise_binaryx_xlogy, |a: f64, b: f64| if a == 0.0 { 0.0 } else { a * b.ln() }, -3.0, 3.0, 0.2, 4.0);
      r!("xlog1py", launch_elementwise_binaryx_xlog1py, |a: f64, b: f64| if a == 0.0 { 0.0 } else { a * b.ln_1p() }, -3.0, 3.0, 0.2, 4.0);
      r!("squared_difference", launch_elementwise_binaryx_squared_difference, |a: f64, b| (a - b) * (a - b), -3.0, 3.0, -2.3, 3.7);
      r!("ge", launch_elementwise_binaryx_ge, |a, b| if a >= b { 1.0 } else { 0.0 }, -3.0, 3.0, -2.3, 3.7);
      r!("le", launch_elementwise_binaryx_le, |a, b| if a <= b { 1.0 } else { 0.0 }, -3.0, 3.0, -2.3, 3.7);
      r!("ne", launch_elementwise_binaryx_ne, |a, b| if a != b { 1.0 } else { 0.0 }, -3.0, 3.0, -2.3, 3.7);
      m
}
...
fn canon(name: &str) -> String {
      ...
      let alias: &[(&str, &str)] = &[
            ...
            ("add", "add"), ("add_", "add"), ("addv2", "add"), ("broadcast_add", "add"),
            ("vector_add", "add"), ("cudnnop_add", "add"), ("cutensorop_add", "add"),
            ("cudnnpointwise_add", "add"), ("stablehlo_add", "add"), ("cudnnaddtensor", "add"),
            ("vxadd", "add"), ("miopenaddnforward", "add"),
            // sub
            ("subtract", "sub"), ("sub_", "sub"), ("broadcast_subtract", "sub"),
            ("vector_sub", "sub"), ("cudnnpointwise_sub", "sub"), ("stablehlo_subtract", "sub"),
            ("vxsubtract", "sub"),
            // mul
            ("multiply", "mul"), ("mul_", "mul"), ("broadcast_multiply", "mul"),
            ("vector_mul", "mul"), ("cudnnop_mul", "mul"), ("cutensorop_mul", "mul"),
            ("cudnnpointwise_mul", "mul"), ("stablehlo_multiply", "mul"), ("vxmultiply", "mul"),
            // div (true division)
            ("divide", "div"), ("div_", "div"), ("true_divide", "div"), ("truediv", "div"),
            ("true_divide_", "div"), ("realdiv", "div"), ("fdiv", "div"), ("div_rn", "div"),
            ("vector_div", "div"), ("broadcast_divide", "div"), ("cudnnpointwise_div", "div"),
            ("stablehlo_divide", "div"),
            // atan2
            ("arctan2", "atan2"), ("broadcast_atan2", "atan2"),
            // fmod (C truncated mod, sign of dividend)
            ("truncatemod", "fmod"),
            // max / min (numpy maximum/minimum == propagate-NaN; our fmax/fmin separate)
            ("max", "maximum"), ("broadcast_maximum", "maximum"), ("vector_max", "maximum"),
            ("cudnnop_max", "maximum"), ("cutensorop_max", "maximum"), ("cudnnpointwise_max", "maximum"),
            ("stablehlo_maximum", "maximum"),
            ("min", "minimum"), ("broadcast_minimum", "minimum"), ("vector_min", "minimum"),
            ("cudnnop_min", "minimum"), ("cutensorop_min", "minimum"), ("cudnnpointwise_min", "minimum"),
            ("stablehlo_minimum", "minimum"),
            // comparisons
            ("greater", "gt"), ("cudnnpointwise_cmp_gt", "gt"),
            ("less", "lt"), ("cudnnpointwise_cmp_lt", "lt"),
            ("equal", "eq"), ("cudnnpointwise_cmp_eq", "eq"),
            ("greater_equal", "ge"), ("greaterequal", "ge"), ("cudnnpointwise_cmp_ge", "ge"),
            ("less_equal", "le"), ("lessequal", "le"), ("cudnnpointwise_cmp_le", "le"),
            ("not_equal", "ne"), ("notequal", "ne"), ("cudnnpointwise_cmp_neq", "ne"),
            // pow
            ("power", "pow"), ("broadcast_power", "pow"), ("cudnnpointwise_pow", "pow"),
            ("stablehlo_power", "pow"), ("float_power", "pow"), ("float_power_aten", "pow"),
            // remainder (numpy/torch: sign of divisor)
            ("rem", "remainder"), ("mod", "remainder"), ("floor_mod", "remainder"),
            ("floormod", "remainder"), ("broadcast_remainder", "remainder"),
            ...
            ("next_after", "nextafter"), ("broadcast_next_after", "nextafter"),
      ];
            ...
            if p.extension().map_or(false, |x| x == "json") {
                  ...
                  if let Some(ks) = v.get("kernels").and_then(|k| k.as_array()) {
                        for k in ks {
                              ...
                              if cat == "elementwise_binary" && !name.is_empty() { items.push((name, cat)); }
                        }
                  }
            }
      }
...
fn prove_elementwise_binary() {
      ...
      assert!(!items.is_empty(), "no elementwise_binary items in inventory");
      let reg = registry();
      ...
      eprintln!("  registered ops: {} ({} passed oracle)", reg.len(), proven_ops.len());
      eprintln!("  covered ops: {:?}", covered_ops);
      eprintln!("PROVE elementwise_binary: {proven} / {total}");

      assert!(failures.is_empty(), "{} registered op(s) FAILED oracle: {:?}", failures.len(), failures);
