...
- [ ] Add shape/stride metadata wrappers around `GpuBuffer` for stronger runtime dimension checks.
- [ ] Add optional compile-time dimensional typing for matrix/tensor operations to prevent shape mismatches earlier.
