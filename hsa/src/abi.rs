...
pub(crate) type HsaStatus = i32; pub(crate) type HsaInfo = i32;

pub(crate) const STATUS_SUCCESS: HsaStatus = 0; pub(crate) const STATUS_ERROR: HsaStatus = 0x1000;
pub(crate) const STATUS_ERROR_INVALID_ARGUMENT: HsaStatus = 0x1001;

pub(crate) const SYSTEM_INFO_VERSION_MAJOR: HsaInfo = 0; pub(crate) const SYSTEM_INFO_VERSION_MINOR: HsaInfo = 1;
...
pub(crate) const AGENT_INFO_NAME: HsaInfo = 0; pub(crate) const AGENT_INFO_VENDOR_NAME: HsaInfo = 1;
pub(crate) const AGENT_INFO_FEATURE: HsaInfo = 2; pub(crate) const AGENT_INFO_PROFILE: HsaInfo = 4;
pub(crate) const AGENT_INFO_WAVEFRONT_SIZE: HsaInfo = 6;
/// `HSA_AGENT_INFO_QUEUES_MAX` from the HSA runtime ABI.
pub(crate) const AGENT_INFO_QUEUES_MAX: HsaInfo = 12; pub(crate) const AGENT_INFO_QUEUE_MIN_SIZE: HsaInfo = 13;
pub(crate) const AGENT_INFO_QUEUE_MAX_SIZE: HsaInfo = 14; pub(crate) const AGENT_INFO_QUEUE_TYPE: HsaInfo = 15;
pub(crate) const AGENT_INFO_NODE: HsaInfo = 16; pub(crate) const AGENT_INFO_DEVICE: HsaInfo = 17;
pub(crate) const AGENT_INFO_VERSION_MAJOR: HsaInfo = 21; pub(crate) const AGENT_INFO_VERSION_MINOR: HsaInfo = 22;
...
pub(crate) const AMD_AGENT_INFO_DOMAIN: HsaInfo = 0xA00F; pub(crate) const AMD_AGENT_INFO_UUID: HsaInfo = 0xA011;
...
pub(crate) const ISA_INFO_NAME_LENGTH: HsaInfo = 0; pub(crate) const ISA_INFO_NAME: HsaInfo = 1;
pub(crate) const ISA_INFO_MACHINE_MODELS: HsaInfo = 5; pub(crate) const ISA_INFO_PROFILES: HsaInfo = 6;
...
pub(crate) const ISA_INFO_FAST_F16_OPERATION: HsaInfo = 9; pub(crate) const ISA_INFO_WORKGROUP_MAX_DIM: HsaInfo = 12;
pub(crate) const ISA_INFO_WORKGROUP_MAX_SIZE: HsaInfo = 13; pub(crate) const ISA_INFO_GRID_MAX_DIM: HsaInfo = 14;
pub(crate) const ISA_INFO_GRID_MAX_SIZE: HsaInfo = 16; pub(crate) const ISA_INFO_FBARRIER_MAX_SIZE: HsaInfo = 17;
...
pub(crate) const SYMBOL_KIND_KERNEL: i32 = 1; pub(crate) const DEFAULT_FLOAT_ROUNDING_MODE_NEAR: i32 = 2;
pub(crate) const SIGNAL_CONDITION_LT: i32 = 2; pub(crate) const WAIT_STATE_ACTIVE: i32 = 1;

pub(crate) const PACKET_TYPE_INVALID: u16 = 1; pub(crate) const PACKET_TYPE_KERNEL_DISPATCH: u16 = 2;
pub(crate) const PACKET_TYPE_BARRIER_AND: u16 = 3; pub(crate) const PACKET_HEADER_ACQUIRE_FENCE_SCOPE: u16 = 9;
pub(crate) const PACKET_HEADER_RELEASE_FENCE_SCOPE: u16 = 11; pub(crate) const FENCE_SCOPE_SYSTEM: u16 = 2;

#[repr(C)]
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq)]
pub(crate) struct HsaAgent { pub(crate) handle: u64, }

#[repr(C)]
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq)]
pub(crate) struct HsaIsa { pub(crate) handle: u64, }

#[repr(C)]
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq)]
pub(crate) struct HsaSignal { pub(crate) handle: u64, }

#[repr(C)]
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq)]
pub(crate) struct HsaMemoryPool { pub(crate) handle: u64, }

#[repr(C)]
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq)]
pub(crate) struct HsaCodeObjectReader { pub(crate) handle: u64, }

#[repr(C)]
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq)]
pub(crate) struct HsaExecutable { pub(crate) handle: u64, }

#[repr(C)]
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq)]
pub(crate) struct HsaLoadedCodeObject { pub(crate) handle: u64, }

#[repr(C)]
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq)]
pub(crate) struct HsaExecutableSymbol { pub(crate) handle: u64, }

#[repr(C)]
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(crate) struct HsaDim3 { pub(crate) x: u32, pub(crate) y: u32, pub(crate) z: u32, }

/// Public large-model layout from `hsa_queue_t`.
#[repr(C)]
#[derive(Debug)]
pub(crate) struct HsaQueue { pub(crate) kind: u32, pub(crate) features: u32, pub(crate) base_address: *mut c_void,
	pub(crate) doorbell_signal: HsaSignal, pub(crate) size: u32, pub(crate) reserved1: u32, pub(crate) id: u64, }

#[repr(C)]
#[derive(Clone, Copy, Debug)]
pub(crate) struct HsaKernelDispatchPacket { pub(crate) header: u16, pub(crate) setup: u16,
	pub(crate) workgroup_size_x: u16, pub(crate) workgroup_size_y: u16, pub(crate) workgroup_size_z: u16,
	pub(crate) reserved0: u16, pub(crate) grid_size_x: u32, pub(crate) grid_size_y: u32, pub(crate) grid_size_z: u32,
	pub(crate) private_segment_size: u32, pub(crate) group_segment_size: u32, pub(crate) kernel_object: u64,
	pub(crate) kernarg_address: *mut c_void, pub(crate) reserved2: u64, pub(crate) completion_signal: HsaSignal, }

/// Public large-model layout from `hsa_barrier_and_packet_t`.
#[repr(C)]
#[derive(Clone, Copy, Debug)]
pub(crate) struct HsaBarrierAndPacket { pub(crate) header: u16, pub(crate) reserved0: u16, pub(crate) reserved1: u32,
	pub(crate) dep_signal: [HsaSignal; 5], pub(crate) reserved2: u64, pub(crate) completion_signal: HsaSignal, }
...
pub(crate) type HsaQueueCreate = unsafe extern "C" fn(
	agent: HsaAgent, size: u32, kind: u32, callback: Option<QueueErrorCallback>, data: *mut c_void,
	private_segment_size: u32, group_segment_size: u32, queue: *mut *mut HsaQueue, ) -> HsaStatus;
...
pub(crate) type HsaExecutableLoadAgentCodeObject = unsafe extern "C" fn(
	HsaExecutable, HsaAgent, HsaCodeObjectReader, *const c_char, *mut HsaLoadedCodeObject, ) -> HsaStatus;
...
pub(crate) type HsaAmdMemoryAsyncCopy = unsafe extern "C" fn(
	*mut c_void, HsaAgent, *const c_void, HsaAgent, usize, u32, *const HsaSignal, HsaSignal, ) -> HsaStatus;
