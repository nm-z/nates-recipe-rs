...
const QWEN_TOKENIZER_CONFIG: &str = include_str!("../examples/datasets/tokenizers/qwen2.5-0.5b/tokenizer_config.json");

fn qwen_template() -> String {
	let cfg: serde_json::Value = serde_json::from_str(QWEN_TOKENIZER_CONFIG).expect("parse tokenizer_config.json");
