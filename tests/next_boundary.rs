...
#[test]
fn next_facade_reaches_every_entry_point_without_external_work() {
...
#[test]
fn next_facade_builders_are_immutable_validated_declarations() {
...
#[test]
fn next_facade_defers_validation_without_hidden_side_effects() {
...
#[test]
fn next_binary_exposes_the_automatic_probe_command() {
	let output = std::process::Command::new(env!("CARGO_BIN_EXE_recipe"))
		.args(["probe", "--help"])
		.output()
		.expect("run next Recipe CLI help");
...
#[test]
fn next_facade_exposes_the_exact_normative_operation_registry() {
...
#[test]
fn next_facade_lowers_an_owned_scalar_recipe() {
...
#[test]
fn next_facade_lowers_a_verified_primitive_recipe() {
...
#[test]
fn next_facade_exposes_finite_compositions_without_claiming_scalar_lowering() {
...
#[test]
fn next_facade_classifies_every_normative_operation() {
...
#[test]
fn next_facade_reaches_bounded_raw_model_format_framing() {
