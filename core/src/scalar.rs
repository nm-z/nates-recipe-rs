...
impl ScalarOpcode {
	...
	pub const fn arity(self) -> usize {
		match self {
			Self::Negate | Self::Absolute | Self::BitNot | Self::BitcastF32ToI32 | Self::BitcastI32ToF32 | Self::Require | Self::IsFinite | Self::IsNan | Self::SquareRoot | Self::Floor | Self::Ceiling | Self::RoundNearestEven | Self::ConvertF32ToI32 | Self::ConvertI32ToF32 => 1,
	...
	pub fn result_dtype(self, operands: &[DType]) -> Option<DType> {
		...
		match self {
			Self::Add | Self::Subtract | Self::Multiply | Self::Divide | Self::Remainder | Self::Negate | Self::Absolute | Self::Minimum | Self::Maximum => {
				operands
					.iter()
			...
			Self::Equal | Self::NotEqual | Self::LessThan | Self::LessThanOrEqual | Self::GreaterThan | Self::GreaterThanOrEqual => (operands[0] == operands[1]).then_some(DType::I32),
			Self::Select => (operands[0] == DType::I32 && operands[1] == operands[2]).then_some(operands[1]),
			Self::BitAnd | Self::BitOr | Self::BitXor | Self::BitNot | Self::ShiftLeft | Self::ShiftRightLogical | Self::ShiftRightArithmetic | Self::Require => {
				operands
					.iter()
					.all(|dtype| *dtype == DType::I32)
					.then_some(DType::I32)
			}
			Self::BitcastF32ToI32 | Self::IsFinite | Self::IsNan | Self::ConvertF32ToI32 => (operands == [DType::F32]).then_some(DType::I32),
			Self::BitcastI32ToF32 | Self::ConvertI32ToF32 => (operands == [DType::I32]).then_some(DType::F32),
			Self::SquareRoot | Self::Floor | Self::Ceiling | Self::RoundNearestEven => (operands == [DType::F32]).then_some(DType::F32),
		}
	}
	...
	pub const fn flops(self) -> u64 {
		match self {
			Self::Add | Self::Subtract | Self::Multiply | Self::Divide | Self::Remainder | Self::Negate | Self::Absolute | Self::Minimum | Self::Maximum | Self::Equal | Self::NotEqual | Self::LessThan | Self::LessThanOrEqual | Self::GreaterThan | Self::GreaterThanOrEqual | Self::SquareRoot | Self::Floor | Self::Ceiling | Self::RoundNearestEven => 1,
			Self::Fma => 2,
			Self::Select | Self::BitAnd | Self::BitOr | Self::BitXor | Self::BitNot | Self::BitcastF32ToI32 | Self::BitcastI32ToF32 | Self::ShiftLeft | Self::ShiftRightLogical | Self::ShiftRightArithmetic | Self::Require | Self::IsFinite | Self::IsNan | Self::ConvertF32ToI32 | Self::ConvertI32ToF32 => 0,
		}
	}
}
	...
	pub fn requires_fault_flag(&self) -> bool {
		self.instructions.iter().any(|instruction| {
			matches!(
				...
				(ScalarOpcode::Require, DType::I32) | (ScalarOpcode::Divide, DType::I32) | (ScalarOpcode::Remainder, DType::I32) | (ScalarOpcode::Negate, DType::I32) | (ScalarOpcode::Absolute, DType::I32)
			)
		})
	}
}

fn validate_signature(validator: &mut Validator, path: &str, opcode: ScalarOpcode, result: DType, operands: &[Option<DType>]) {
