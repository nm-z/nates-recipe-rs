...
fn main() -> BuildResult<()> {
	...
	for (key, environment) in [
		...
		("rat-exploration", "RECIPE_RAT_EXPLORATION"),
		("rat-benchmark-rate", "RECIPE_RAT_BENCHMARK_RATE"),
		("rat-proposer-rate", "RECIPE_RAT_PROPOSER_RATE"),
		("rat-lut-rate", "RECIPE_RAT_LUT_RATE"),
		("rat-measurements", "RECIPE_RAT_MEASUREMENTS"),
