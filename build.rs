...
fn main() -> BuildResult<()> {
	...
	for (key, environment) in [
		...
		("tuning-budget-per-direction", "RECIPE_TUNING_BUDGET_PER_DIRECTION"),
		("tuning-candidates", "RECIPE_TUNING_CANDIDATES"),
		("tuning-measurements", "RECIPE_TUNING_MEASUREMENTS"),
		("tuning-warmups", "RECIPE_TUNING_WARMUPS"),
		("tuning-minimum-improvement", "RECIPE_TUNING_MINIMUM_IMPROVEMENT"),
