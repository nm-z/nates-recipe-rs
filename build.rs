...
fn main() -> BuildResult<()> {
	...
	for (key, environment) in [
		...
		("gfx1101-fp32-fma-flops-per-second", "RECIPE_GFX1101_FP32_FMA_FLOPS_PER_SECOND"),
		("gfx1101-fp32-arithmetic-ops-per-second", "RECIPE_GFX1101_FP32_ARITHMETIC_OPS_PER_SECOND"),
		("gfx1101-fp32-comparison-ops-per-second", "RECIPE_GFX1101_FP32_COMPARISON_OPS_PER_SECOND"),
		("gfx1101-fp32-selection-ops-per-second", "RECIPE_GFX1101_FP32_SELECTION_OPS_PER_SECOND"),
		("gfx1101-fp32-division-ops-per-second", "RECIPE_GFX1101_FP32_DIVISION_OPS_PER_SECOND"),
		("gfx1101-fp32-square-root-ops-per-second", "RECIPE_GFX1101_FP32_SQUARE_ROOT_OPS_PER_SECOND"),
		("gfx1101-vram-read-bytes-per-second", "RECIPE_GFX1101_VRAM_READ_BYTES_PER_SECOND"),
		("gfx1101-vram-write-bytes-per-second", "RECIPE_GFX1101_VRAM_WRITE_BYTES_PER_SECOND"),
		("gfx1101-pcie-host-to-device-bytes-per-second", "RECIPE_GFX1101_PCIE_HOST_TO_DEVICE_BYTES_PER_SECOND"),
		("gfx1101-pcie-device-to-host-bytes-per-second", "RECIPE_GFX1101_PCIE_DEVICE_TO_HOST_BYTES_PER_SECOND"),
		("gfx1101-kernel-packet-floor-seconds", "RECIPE_GFX1101_KERNEL_PACKET_FLOOR_SECONDS"),
	] {
