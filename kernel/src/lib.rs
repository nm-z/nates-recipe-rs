...
mod artifact; mod audit; mod builder; mod error; mod llvm; mod stage; mod target;

pub use artifact::{ ArtifactDigest, HsaKernelArgument, HsaKernelMetadata, InspectedCubin, InspectedHsaco, inspect_cubin,
	inspect_hsaco, inspect_hsaco_bundle, }; pub use audit::{AuditFinding, AuditKind, audit_llvm_ir}; pub use builder::{
...
pub fn lower_stage( program: &recipe_primitives::LoweredProgram, build: &recipe_core::ArtifactBuildRecipe,
