...
fn main() {
      ...
      let data = Data::load()
            .set("examples/predict-the-handwriting-images/train.csv")
            .set("examples/predict-the-handwriting-images/train_images/")
            .split(0.8)
            .target("label");
      ...
      // 5. image classification — handwriting with conv layers
      let data = Data::load()
            .set("examples/predict-the-handwriting-images/train.csv")
            .set("examples/predict-the-handwriting-images/train_images/")
            .split(0.8)
      ...
      // 9. competition submission — house prices with test set
      let data = Data::load()
            .set("examples/house-prices/train.csv")
