...
use recipe_core::{AliasPermission, DType, FlopCount, KernelTemplateId, ScalarLiteral, ScalarOpcode, ScalarProgram, ValueId};
...
fn validate_elementwise(id: KernelTemplateId, spec: &Elementwise, inputs: &[&Tensor], outputs: &[&Tensor]) -> LanguageResult<()> {
	spec.program
		.validate()
		.map_err(|errors| LanguageError::new(LanguageErrorKind::InvalidScalarProgram, errors.to_string()).for_kernel(id))?;
	require_arity(
		id,
		"elementwise input",
		inputs.len(),
...
fn validate_contraction(id: KernelTemplateId, spec: &Contraction, inputs: &[&Tensor], outputs: &[&Tensor]) -> LanguageResult<()> {
...
fn validate_scatter(id: KernelTemplateId, spec: Scatter, inputs: &[&Tensor], outputs: &[&Tensor]) -> LanguageResult<()> {
...
fn validate_histogram(id: KernelTemplateId, spec: Histogram, inputs: &[&Tensor], outputs: &[&Tensor]) -> LanguageResult<()> {
...
fn validate_index_map(id: KernelTemplateId, spec: IndexMap, inputs: &[&Tensor], outputs: &[&Tensor]) -> LanguageResult<()> {
...
fn validate_random(id: KernelTemplateId, spec: RandomMap, inputs: &[&Tensor], outputs: &[&Tensor]) -> LanguageResult<()> {
