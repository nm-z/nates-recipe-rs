...
pub(crate) fn unavailable_validation_line(status: ValidationMetricStatus) -> Option<String> {
	let ValidationMetricStatus::Unavailable { family, reason, split_rows, } = status
	else { return None; }; let family = match family {
