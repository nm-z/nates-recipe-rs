...
pub use bayes::{
	CategoricalBayesInferenceMaterialization, CategoricalBayesInferenceRequest,
...
pub use kmeans::{
	...
	materialize_kmeans_initialization, materialize_kmeans_lloyd_step,
};
pub use knn_outputs::{
	KnnAllOutputMaterialization, KnnAllOutputRequest, KnnAllOutputRequirements, KnnOutputRequest,
	KnnOutputRequirement, KnnOutputSpec, append_knn_all_outputs, knn_all_output_requirements,
...
pub use scalar::{
	...
	canonical_selu_program, lower_scalar,
};
pub use tree::{
