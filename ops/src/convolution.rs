...
pub fn prepare_channelwise_convolution_1d(batch: u64, input_length: u64, input_channels: u64, filters: u64, kernel_size: u64) -> OperationResult<ChannelwiseConvolution1dPreparation> {
	for (name, value) in [
		("batch", batch),
