...
fn emit_checked_flat_gather(
	request: &MaterializationRequest<'_>,
	emitter: &mut Emitter<'_>,
	values: &recipe_language::Tensor,
	indices: &recipe_language::Tensor,
	result: &recipe_language::Tensor,
) -> OperationResult<()> {
...
fn pool_axis(request: &MaterializationRequest<'_>) -> OperationResult<AxisSet> {
